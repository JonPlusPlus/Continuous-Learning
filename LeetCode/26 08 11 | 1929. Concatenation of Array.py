# # Function to solve task in time = O(n), and space O(n).
# def concatenationOfArray(ans):
...
# print(concatenationOfArray(nums))
...
# Solves task to a complexity of: time = O(n), space O(n).
class Solution:
